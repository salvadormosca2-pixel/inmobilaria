...
const leads = [
  {
    ...
    resumenIA: "Interesada en casas de 3+ dormitorios en Valle Viejo. Presupuesto entre USD 200.000 y USD 300.000. Busca barrio cerrado con pileta. Familia de 4.",
    estado: "nuevo",
    atendido: false,
    notaVendedor: "",
  },
  {
    ...
    resumenIA: "Consulta por el Penthouse Centro Histórico. Inversor, tiene 2 propiedades en Córdoba. Preguntó por rentabilidad de alquiler temporario.",
    estado: "contactado",
    atendido: true,
  ...
  },
  {
    ...
    resumenIA: "Busca departamento en alquiler en zona centro. Profesional médica, se muda a Catamarca por trabajo. Necesita 1-2 ambientes amoblado.",
    estado: "en_seguimiento",
    atendido: true,
    notaVendedor: "Le ofrecí el depto amoblado de Centro. Quiere verlo el lunes.",
  },
  {
    nombre: "Roberto Sánchez",
    telefono: "+54 383 678-3456",
    resumenIA: "Pregunta por terrenos en Fray M. Esquiú y Valle Viejo. Quiere construir casa de fin de semana. Presupuesto flexible.",
    estado: "nuevo",
    atendido: false,
    notaVendedor: "",
  },
  {
    ...
    resumenIA: "Quiere vender su casa en Capital. 3 dormitorios, 200m². Pide tasación. También preguntó por el Complejo Solares del Valle.",
    estado: "contactado",
    atendido: true,
